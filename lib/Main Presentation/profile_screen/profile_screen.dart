              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildAppointmentRow(context, appointment: "Prescription"),
                      SizedBox(height: 13.v),
                      Divider(color: appTheme.blueGray50),
                      SizedBox(height: 13.v),
                      _buildAppointmentRow(context, appointment: "Appointment"),
                      SizedBox(height: 13.v),
                      Divider(color: appTheme.blueGray50),
                      SizedBox(height: 13.v),
                      _buildAppointmentRow(context, appointment: "Payment Method"),
                      SizedBox(height: 13.v),
                      Divider(color: appTheme.blueGray50),
                      SizedBox(height: 13.v),
                      _buildAppointmentRow(context, appointment: "FAQs"),
                      SizedBox(height: 13.v),
                      Divider(color: appTheme.blueGray50),
                      SizedBox(height: 13.v),
  ...
  Widget _buildBottomBar(BuildContext context) {
    return NavigationBarTheme(
      ...
      child: NavigationBar(
        ...
        selectedIndex: 4, // Change this to the appropriate index for Profile screen
        onDestinationSelected: (index) {
          // Handle navigation here
          // You can use Navigator or any other navigation mechanism you prefer
        },
        destinations: [
