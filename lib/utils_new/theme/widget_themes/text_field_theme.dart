...
class CustomTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    hintStyle: const TextStyle().copyWith(fontSize: CustomSizes.fontSizeMd, color: CustomColors.black),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    hintStyle: const TextStyle().copyWith(fontSize: CustomSizes.fontSizeMd, color: CustomColors.white),
